...
const motifStyle = css(
	mq({
		...
		right: [-90, -70, -50],
		background:
			"linear-gradient(120deg, transparent var(--p3), white var(--p3), white var(--p4), transparent var(--p4), transparent 100%)",
		fill: "white",
...
export const AboutHead1 = ({ text, bgText }: AboutHead1Props) => {
	return (
