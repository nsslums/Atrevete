                    ...
                    <div css={footerWrap}>
                        ...
                        <div css={menuWrap}>
                            <div css={menuInner}>
                                ...
                                <Link to='/staff' css={link}>運営メンバー</Link>
                                <Link to='/attendee' css={link}>参加者一覧</Link>
                                <Link to='/post' css={link}>投稿</Link>
                                <Link to='/privacy' css={link}>プライバシーポリシー</Link>
                            </div>
                            <div css={menuInner}>
                                <p css={head}>フォーム</p>
                                <Link to='/contact' css={link}>お問い合わせ</Link>
                                <Link to='/eventForm' css={link}>お申し込み</Link>
                            </div>
                            <div css={menuInner}>
                                <p css={head}>SNS</p>
                                <a href="https://www.instagram.com/atrevete__official/" target="_blank" css={link}>Instagram</a>
                            </div>
                        </div>
                    </div>
                </div>
