        ...
        <Common>
            <div css={rootStyle}>
                ...
                <AboutSection
                    ...
                    reverse='row-reverse'
                >
                    <p css={mq({textAlign:['center','center','center','right'],fontSize:'1.7em', lineHeight:'70px', letterSpacing:'0.2em', fontWeight:700})}>
                        迷いを確信に。<br/>
                        夢を現実に。
                    </p>
                </AboutSection>
                ...
                >
                    日本の<wbr/>課題でもある<wbr/>「若者の育成をどうしていくか」<wbr/>に着目し、<wbr/>夢ある者、<wbr/>迷いながらも<wbr/>進もうとする者、<wbr/>
                    何をしたらいいか<wbr/>わからない者を<wbr/>サポートします。<br/>
                    迷いがある者は、<wbr/>迷いを確信へ。<br/>
                    希望に<wbr/>満ち溢れる<wbr/>若者が<wbr/>世の中の<wbr/>理不尽に<wbr/>振り回されず、<wbr/>
                    自分自身が<wbr/>主体でいれるよう、<wbr/>全身全霊で<wbr/>「人×人」<wbr/>の場所を提供します。
                </motion.p>
            </div>
            ...
            >
                <p css={mq({textAlign:['center','center','center','right']})}>
                    ...
                    そこで、<wbr/>優秀な学生や<wbr/>能力ある<wbr/>若者を<wbr/>起業家、<wbr/>投資家や<wbr/>社会人、<wbr/>様々な<wbr/>業種の方との<wbr/>交友する<wbr/>場所を<wbr/>提供します。<br/>
